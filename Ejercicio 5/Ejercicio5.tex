...
\begin{figure}[H]
	...
	\includegraphics[width=0.5\textwidth]{rtl2.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{simulacion_senales.png}
	\caption{Simulación funcional mostrando las señales de entrada y salida.}
	\label{fig:simulacion-senales}
\end{figure}
